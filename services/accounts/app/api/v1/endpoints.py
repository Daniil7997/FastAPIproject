...
from app.schemas.pydantic_schemas import (User, 
                                          ...
                                          TokensPayload,
                                          UserConfirmPass)
from app.repositories.crud import create_user, find_user_by_email, change_user_data
from app.core.security import verify_password, create_tokens, hash_password
...
async def get_token(user_data: User, db: AsyncSession = Depends(get_db)) -> GetToken:
    ...
    check_password: bool = verify_password(raw_password=user_data.password,
